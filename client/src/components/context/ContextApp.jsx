...
function ContextProvider({children}) {
    const [socket, setSocket] = useState(null),
        ...
        routes = [
            {text: "Meus aluguéis", path: '/my-rent', iconName: 'home-outline', DescPath: ({given_name}) => `Página onde fica a lista dos aluguéis realizados por ${given_name}.`},
            ...
            {text: "Minhas Conversas", path: '/chats', iconName: 'chatbubbles-outline', DescPath: ({given_name}) => `Aqui é onde ficam as conversas de ${given_name} com outros usuários.`}
        ],
